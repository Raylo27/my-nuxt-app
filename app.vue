      ...
      <section id="projects" class="flex flex-col gap-8">
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div class="flex flex-col gap-1 rounded-sm bg-white-secondary p-4 dark:bg-black-secondary border border-[#ffffff2e]">
            <a class="text-dark-primary text-xl font-semibold dark:text-white-primary" href="https://github.com/Raylo27" rel="noreferrer noopener" target="_blank">Attendance Recovery (Senior Project)</a>
